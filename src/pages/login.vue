...
// const primaryContent = ref<HTMLDivElement>()
// const secondaryContent = ref<HTMLDivElement>()
...
// 		route.query.sent
// 			? secondaryContent.value?.clientHeight || 0
// 			: primaryContent.value?.clientHeight || 0
// 	}px`
// })
...
<template>
	<div class="duration-300 h-full" ref="container">
		<Transition
			...
			mode="out-in"
		>
			<div v-if="$route.query.sent" ref="secondaryContent">
					...
					<Stack gap="4" vertical>
						...
						<Stack class="text-center" gap="2" vertical>
							...
							<p class="text-secondary">
								Si no lo ves, por favor revisa el apartado de
								spam
							</p>
						</Stack>
					</Stack>
